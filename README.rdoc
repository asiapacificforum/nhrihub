...
=== Ruby version
configured in the .ruby-version file, look in that file for the currently-configured version
...
Integration testing uses Rspec. The tests are in spec/features.

...
(function() {
  this.UserInputManager = (function() {
    function UserInputManager() {
      this.user_input_claimant = null;
      this.undo = null;
    }

    UserInputManager.prototype.claim_user_input_request = function(user_input_claimant, undo) {
      if (this.user_input_claimant) {
        this.terminate_user_input_request();
      }
      this.user_input_claimant = user_input_claimant;
      return this.undo = undo;
    };

    UserInputManager.prototype.terminate_user_input_request = function() {
      return this.user_input_claimant[this.undo]();
    };

    UserInputManager.prototype.reset = function() {
      this.user_input_claimant = null;

...
feature "advisory council minutes document", :js => true do
  ...
  before do
    ...
    FactoryGirl.create(:advisory_council_minutes, :date => Date.new(2014,8,19).to_time.utc)
    FactoryGirl.create(:advisory_council_minutes, :date => Date.new(2015,8,19).to_time.utc)
    FactoryGirl.create(:advisory_council_minutes, :date => Date.new(2013,8,19).to_time.utc)

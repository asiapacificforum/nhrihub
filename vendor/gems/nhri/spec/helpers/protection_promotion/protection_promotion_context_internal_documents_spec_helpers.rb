...
module ProtectionPromotionContextInternalDocumentsSpecHelpers
  extend RSpec::Core::SharedContext
  def populate_database
    current_doc_rev = first_doc_rev = (rand(49)+50).to_f/10
    doc = FactoryGirl.create(:protection_promotion_internal_document,
    ...
    4.times do |i|
      ...
      FactoryGirl.create(:protection_promotion_internal_document,
  ...
  def index_path
    nhri_protection_promotion_internal_documents_path('en')
  end
  ...
  def document_model
    Nhri::ProtectionPromotion::InternalDocument
  end
  ...
  def create_a_document(**options)
    ...
    doc = FactoryGirl.create(:protection_promotion_internal_document, options)
  end
  ...
  def create_a_document_in_the_same_group(**options)
    ...
    FactoryGirl.create(:protection_promotion_internal_document, options)
  end
end

class Nhri::HumanRightsAttribute < ActiveRecord::Base
  ...
  has_many :process_indicators, ->{ where("nature = 'Process'") }, :class_name => 'Nhri::Indicator'
  has_many :outcomes_indicators, ->{ where("nature = 'Outcomes'") }, :class_name => 'Nhri::Indicator'

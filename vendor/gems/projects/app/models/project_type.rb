class ProjectType < ActiveRecord::Base
  ...
  belongs_to :strategic_plan_mandate, ->{merge Mandate.strategic_plan},:class_name => "Mandate", :foreign_key => :mandate_id
  ...
  scope :strategic_plan, ->{ joins(:strategic_plan_mandate)}

class ProjectType < ActiveRecord::Base
  ...
  belongs_to :corporate_services_mandate, ->{merge Mandate.corporate_services},:class_name => "Mandate", :foreign_key => :mandate_id
  ...
  scope :corporate_services, ->{ joins(:corporate_services_mandate)}

...
require_relative '../helpers/good_governance_context_internal_documents_spec_helpers'
#require_relative '../helpers/good_governance_internal_documents_spec_helpers'
...
feature "internal doc behaviour", :js => true do
  ...
  #include GoodGovernanceInternalDocumentsSpecHelpers
  include InternalDocumentDefaultSettings
  include GoodGovernanceContextInternalDocumentsSpecHelpers

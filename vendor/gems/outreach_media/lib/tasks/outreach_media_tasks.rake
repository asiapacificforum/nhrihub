...
namespace :outreach_media do
  ...
  task :populate => :environment do
    ...
    Rake::Task["outreach_media:populate_vs"].invoke
    Rake::Task["outreach_media:populate_pr"].invoke
    Rake::Task["outreach_media:populate_ir"].invoke
    Rake::Task["outreach_media:populate_at"].invoke
    Rake::Task["outreach_media:populate_areas"].invoke
    Rake::Task["outreach_media:populate_media"].invoke
    Rake::Task["outreach_media:populate_outreach"].invoke
  end
end

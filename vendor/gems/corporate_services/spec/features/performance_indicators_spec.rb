...
feature "populate activity performance indicators", :js => true do
  ...
  feature "add performance indicator when there were none before" do
    ...
    scenario "add single performance indicator item" do
      ...
      expect{save_performance_indicator.click; sleep(0.2)}.to change{PerformanceIndicator.count}.from(0).to(1)
    ...
    scenario "try to save performance indicator with blank description field" do
      #expect(page).not_to have_selector("i.new_performance_indicator")
      expect{save_performance_indicator.click; sleep(0.2)}.not_to change{PerformanceIndicator.count}
    ...
    scenario "add multiple performance indicator items" do
      ...
      expect{save_performance_indicator.click; sleep(0.2)}.to change{PerformanceIndicator.count}.from(1).to(2)
...
feature "actions on existing performance indicators", :js => true do
  ...
  scenario "delete the first of multiple performance indicators" do
    ...
    expect{ page.find(performance_indicator_selector + "span.delete_icon").click; sleep(0.2)}.to change{PerformanceIndicator.count}.from(2).to(1)
  ...
  scenario "edit the first of multiple performance indicators" do
    ...
    expect{ performance_indicator_save_icon.click; sleep(0.3) }.to change{ PerformanceIndicator.first.description }.to "new description"
  ...
  scenario "edit to blank description and cancel" do
    ...
    expect{ performance_indicator_save_icon.click; sleep(0.2) }.not_to change{ PerformanceIndicator.first.description }

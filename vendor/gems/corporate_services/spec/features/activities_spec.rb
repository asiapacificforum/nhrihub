...
feature "actions on existing activities", :js => true do
  ...
  before do
    ...
    Activity.create(:outcome_id => o.id, :description => "work hard", :target => "15% improvement")
    Activity.create(:outcome_id => o.id, :description => "do the right thing", :target => "85% improvement")
    visit corporate_services_strategic_plan_path(:en, "current")
    open_accordion_for_strategic_priority_one
  end
